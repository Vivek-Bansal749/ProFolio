...
export const getMyConnectionRequests = async (req,res)=>{
    // token may come from query (GET) or body (POST)
...
export const whatAreMyConnections = async (req,res)=>{
    ...
    try{
        ...
        // when fetching requests received by this user we want details of
        // *who* sent them, not the recipient (which is the current user)

...
function DashBoard() {
    ...
    // console.log(authState.profileFetched);
    if(authState.user){
        return (
            <UserLayout>
                <DashBoardLayout>
                    <div className={styles.scroll}>
                        ...
                        <div className={styles.createPostContainer}>
                            <img className={styles.userProfile} src={authState.user.userId.profilePicture} alt="Profile" />
                                                ...
                                                <div>
                                                    ...
                                                    <div className={styles.optionsContainer}>
                                                        ...
                                                        <div onClick={()=>{
                                                            ...
                                                            const url = encodeURIComponent("ProFolio.in")
